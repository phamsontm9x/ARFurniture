...
@property (nonatomic, strong) TYCyclePagerTransformLayout *layoutTransform;
...
- (void)addCollectionView {
    _layoutTransform = [[TYCyclePagerTransformLayout alloc]init];
    UICollectionView *collectionView = [[UICollectionView alloc]initWithFrame:CGRectZero collectionViewLayout:_layoutTransform];
    _layoutTransform.delegate = _delegateFlags.applyTransformToAttributes ? self : nil;;
...
- (void)setLayoutTypePage:(TYCyclePagerTransformLayoutType)layoutTypePage {
    _layoutTypePage = layoutTypePage;
    self.layout.layoutType = layoutTypePage;
